...
def main() -> None:
    ...
    for _ in range(amount):
        fast_cnum_converter.convert_cnum_to_alpha(random.randrange(1, 1_576_782_335), True)  # noqa: S311
    ...
    for _ in range(amount):
        cnum_converter.convert_cnum_to_alpha(random.randrange(1, 1_576_782_335))  # noqa: S311
